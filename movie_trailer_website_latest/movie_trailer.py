...
<head>
    ...
    <style type="text/css" media="screen">
        body {
            ...
            background-image: url("C:/Users/Tanishq arya/Downloads/archive_latest/background img.jpg");
        }
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <h2 style= "color: ivory;">{movie_title}</h2>
    <h4 style= "color: ivory; font-style: italic;">{movie_genre}</h4>
    <b style= "color: ivory; font-weight: bolder;">{movie_year}</b>
</div>
'''
